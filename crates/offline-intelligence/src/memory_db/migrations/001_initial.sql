...
CREATE TABLE IF NOT EXISTS tier3_content (
    ...
    source_message_ids TEXT,  -- JSON array: [1, 2, 3]
...
-- Create default session that your logs show is being used
INSERT OR IGNORE INTO sessions (id, created_at, last_accessed, metadata)
VALUES (
    'default_session',
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP,
    '{"system": "default", "auto_created": true, "description": "Default conversation session"}'
);